        ...
        <div class="shopping-list-book-text">
          ...
          <div class="shopping-list-book-links">
            <a class="test-link" href="${d.url}">
              <img width="32" height="11" class="shopping-list-amazon" src="../img/amazon-s.png" alt="${d.name}"/>             
            </a>
            <a class="test-link" href="${u.url}">
              <img width="16" height="16" class="shopping-list-apple" src="../img/apple-s.png" alt="${u.name}"/>             
            </a>
          </div>
...
//# sourceMappingURL=header-9f5a6f76.js.map
