import{a as b,b as C,c as x,d as h,e as T,f as $,r as n}from"./assets/support-5efc77ee.js";import{a as l,i as w}from"./assets/vendor-e2ce0d38.js";class u{constructor(){this.BASE_URL="https://books-backend.p.goit.global/books"}async getCategoriesList(){const t=this.BASE_URL+"/category-list";return(await l.get(t)).data}async getPopularBooks(){const t=this.BASE_URL+"/top-books ";return(await l.get(t)).data}async getSelectedCategory(t){const o=this.BASE_URL+`/category?category=${t}`;return(await l.get(o)).data}async getBookDetailedInfo(t){const o=this.BASE_URL+`/${t}`;return(await l.get(o)).data}}function S(e){return`<div class="modal-backdrop">
