import{r as a}from"./assets/header-43b7b4ac.js";import{a as r}from"./assets/vendor-de8bc860.js";class p{constructor(){this.BASE_URL="https://books-backend.p.goit.global/books"}async getCategoriesList(){const e=this.BASE_URL+"/category-list";return(await r.get(e)).data}async getPopularBooks(){const e=this.BASE_URL+"/top-books ";return(await r.get(e)).data}async getSelectedCategory(e){const o=this.BASE_URL+`/category?category=${e}`;return(await r.get(o)).data}async getBookDetailedInfo(e){const o=this.BASE_URL+`/${e}`;return(await r.get(o)).data}}function u(t){const e=document.querySelector(".modal-btn");let o=JSON.parse(localStorage.getItem("shoppingList"))||[],s;const n=o.findIndex(i=>t._id===i._id);n===-1?(o.push(t),s="remove from shopping list"):(o.splice(n,1),s="add to shopping list"),localStorage.setItem("shoppingList",JSON.stringify(o)),e.textContent=s}function g(t){const e=document.querySelector(".modal-btn");let o=JSON.parse(localStorage.getItem("shoppingList"))||[],s;o.findIndex(i=>t._id===i._id)===-1?s="add to shopping list":s="remove from shopping list",e.textContent=s}function k(t){return`<div class="modal-backdrop">
  ...
  </li>`}function B(t){return t.map(y).join("")}function m(t){const e=B(t);a.categoriesMain.insertAdjacentHTML("beforeend",e)}const c=new p;async function C(){let t;try{t=await c.getCategoriesList()}catch(e){console.log(e);return}L(t)}C();let d;a.categoriesListMain.addEventListener("click",A);async function A(t){t.preventDefault();let e;if(a.categoriesMain.innerHTML="",t.target!==t.currentTarget){if(d=t.target.closest("li"),d.textContent==="All categories")try{const o=await c.getPopularBooks();console.log(o);const s=o.map(n=>n.books);s.map(n=>m(n)),console.log(s)}catch{console.log("error")}try{e=await c.getSelectedCategory(d.textContent)}catch{console.log("error")}console.log(e),m(e)}}a.categoriesMain.addEventListener("click",async t=>{if(t.target===t.currentTarget)return;const e=t.target.closest(".book-item").dataset.id,o=await c.getBookDetailedInfo(e),s=k(o);b(s),g(o),document.querySelector(".modal-btn").addEventListener("click",i=>{i.preventDefault(),u(o),f()})});
