import{a as h,b as x,c as T,d as f,e as $,f as w,r as n}from"./assets/support-74f551e0.js";import{a as r,i as S}from"./assets/vendor-e2ce0d38.js";class u{constructor(){this.BASE_URL="https://books-backend.p.goit.global/books"}async getCategoriesList(){const t=this.BASE_URL+"/category-list";return(await r.get(t)).data}async getPopularBooks(){const t=this.BASE_URL+"/top-books ";return(await r.get(t)).data}async getSelectedCategory(t){const o=this.BASE_URL+`/category?category=${t}`;return(await r.get(o)).data}async getBookDetailedInfo(t){const o=this.BASE_URL+`/${t}`;return(await r.get(o)).data}}function B(e){return`<div class="modal-backdrop">
  ...
  " src="${h}" alt="amazon" />
    ...
    <button type="submit" class="modal-btn"></button>
       ...
       To delete, press the button "Remove from the shopping list".</p>`)}}function _(e){document.querySelector(".modal-content-container").insertAdjacentHTML("beforeend",e)}function E(e){const t=document.querySelector(".modal-btn");let o=JSON.parse(localStorage.getItem("shoppingList"))||[],s;const a=o.findIndex(i=>e._id===i._id);a===-1?(o.push(e),s="remove from shopping list"):(o.splice(a,1),s="add to shopping list"),localStorage.setItem("shoppingList",JSON.stringify(o)),t.textContent=s}function q(e){const t=document.querySelector(".modal-btn");let o=JSON.parse(localStorage.getItem("shoppingList"))||[],s;o.findIndex(i=>e._id===i._id)===-1?s="add to shopping list":s="remove from shopping list",t.textContent=s}function j(e){const{book_image:t,title:o,author:s,_id:a}=e;return`<li class="book-item" data-id="${a}">
