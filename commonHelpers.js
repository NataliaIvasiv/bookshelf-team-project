import"./assets/header-d8965ae6.js";import{a as r}from"./assets/vendor-de8bc860.js";class u{constructor(){this.BASE_URL="https://books-backend.p.goit.global/books"}async getCategoriesList(){const o=this.BASE_URL+"/category-list";return(await r.get(o)).data}async getPopularBooks(){const o=this.BASE_URL+"/top-books ";return(await r.get(o)).data}async getSelectedCategory(o){const e=this.BASE_URL+`/category?category=${o}`;return(await r.get(e)).data}async getBookDetailedInfo(o){const e=this.BASE_URL+`/${o}`;return(await r.get(e)).data}}function g(t){const o=document.querySelector(".modal-btn");let e=JSON.parse(localStorage.getItem("shoppingList"))||[],s;const n=e.findIndex(a=>t._id===a._id);n===-1?(e.push(t),s="remove from shopping list"):(e.splice(n,1),s="add to shopping list"),localStorage.setItem("shoppingList",JSON.stringify(e)),o.textContent=s}function p(t){const o=document.querySelector(".modal-btn");let e=JSON.parse(localStorage.getItem("shoppingList"))||[],s;e.findIndex(a=>t._id===a._id)===-1?s="add to shopping list":s="remove from shopping list",o.textContent=s}function k(t){return`<div class="modal-backdrop">
    ...
    </div>`}function b(t){document.body.insertAdjacentHTML("beforeend",t)}function f(){const t=document.querySelector(".modal-backdrop"),o=document.querySelector(".modal-close-btn");document.addEventListener("keydown",e=>{e.preventDefault(),e.key==="Escape"&&c()}),o.addEventListener("click",e=>{e.preventDefault(),c()}),t.addEventListener("click",e=>{e.preventDefault(),e.target===t&&c()})}function c(){const t=document.querySelector(".modal-backdrop"),o=document.querySelector(".modal-close-btn");t.parentNode.removeChild(t),document.removeEventListener("keydown",e=>{console.log("listener is remove")}),o.removeEventListener("click",e=>{console.log("listener is remove")}),t.removeEventListener("click",e=>{console.log("listener is remove")})}const m={categoriesMain:document.querySelector(".all-categories-main")},y=document.querySelector(".categories-list-main");function h(t){return t.map(o=>`<li class='categories-list-item'><a href="">${o.list_name}</a></li>`).join("")}function v(t){const o=h(t);y.insertAdjacentHTML("beforeend",o)}function L(t){const{book_image:o,title:e,author:s,_id:n}=t;return`<li class="book-item" data-id="${n}">
