import{r as s}from"./assets/modal-sign-up-28113555.js";import{a as c,i as k}from"./assets/vendor-fe89f55d.js";class d{constructor(){this.BASE_URL="https://books-backend.p.goit.global/books"}async getCategoriesList(){const e=this.BASE_URL+"/category-list";return(await c.get(e)).data}async getPopularBooks(){const e=this.BASE_URL+"/top-books ";return(await c.get(e)).data}async getSelectedCategory(e){const o=this.BASE_URL+`/category?category=${e}`;return(await c.get(o)).data}async getBookDetailedInfo(e){const o=this.BASE_URL+`/${e}`;return(await c.get(o)).data}}function b(t){const e=document.querySelector(".modal-btn");let o=JSON.parse(localStorage.getItem("shoppingList"))||[],n;const i=o.findIndex(a=>t._id===a._id);i===-1?(o.push(t),n="remove from shopping list"):(o.splice(i,1),n="add to shopping list"),localStorage.setItem("shoppingList",JSON.stringify(o)),e.textContent=n}function f(t){const e=document.querySelector(".modal-btn");let o=JSON.parse(localStorage.getItem("shoppingList"))||[],n;o.findIndex(a=>t._id===a._id)===-1?n="add to shopping list":n="remove from shopping list",e.textContent=n}function h(t){return`<div class="modal-backdrop">
    ...
    </div>`}function L(t){document.body.insertAdjacentHTML("beforeend",t)}function v(){const t=document.querySelector(".modal-backdrop"),e=document.querySelector(".modal-close-btn");document.addEventListener("keydown",o=>{o.preventDefault(),o.key==="Escape"&&l()}),e.addEventListener("click",o=>{o.preventDefault(),l()}),t.addEventListener("click",o=>{o.preventDefault(),o.target===t&&l()})}function l(){const t=document.querySelector(".modal-backdrop"),e=document.querySelector(".modal-close-btn");t&&t.parentNode&&t.parentNode.removeChild(t),e&&(document.removeEventListener("keydown",o=>{console.log("listener is remove")}),e.removeEventListener("click",o=>{console.log("listener is remove")}),t.removeEventListener("click",o=>{console.log("listener is remove")}))}function y(t){const{book_image:e,title:o,author:n,_id:i}=t;return`<li class="book-item" data-id="${i}">
